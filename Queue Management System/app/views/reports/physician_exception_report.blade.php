...
//                startDate: "1d",
            ...
            function getReport() {
                ...
                withMe('#withMe');
                $.ajax({
                    url: '{{route('postPhysicianExceptionReports')}}',
                    method: 'POST',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        if (data.response == 'false') {
                            ...
                            window.history.pushState('', '', '?' + $("#getPhysicianExceptionReportForm").serialize());
            ...
            $("#download_excel").click(function (e) {
                window.location.href = '{{route('excelPhysicianExceptionReport')}}?' + $("#getPhysicianExceptionReportForm").serialize();
            });
        ...
        <div class="row" id="withMe">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    {{Form::open(array('method' => 'GET', 'id' => 'getPhysicianExceptionReportForm'))}}
                    <div class="box-body">
