        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <!-- form start -->
                    {{Form::open(array('route' => 'createPublicHoliday','role'=>"form"))}}
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" data-date-format="yyyy-mm-dd" value="{{Input::old('from_date')}}"
                                   name="from_date" class="form-control datepicker">
                        </div>

                        <div class="form-group col-md-6">
                            <label>To Date</label>
                            <input type="text" data-date-format="yyyy-mm-dd" value="{{Input::old('to_date')}}"
